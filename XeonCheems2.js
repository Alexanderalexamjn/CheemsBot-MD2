...
reply(`Successfully Reported To The Owner\n\nPlease Make Sure The Bug Is Valid, If You Play With This, Use This Feature Again And Again For No Reason, You Will Be Blocked For Sure !`)
                    ...
                    break
                    case 'tes': case 'test': case 'alive': case 'bot': case 'robot': case 'mdbot': case 'doge':{
                           	timestampe = speed();
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                XeonBotInc.sendMessage(m.chat, { image: { url: 'https://i.imgur.com/m6kSmBp.jpeg' }, caption: `*Hi Bro ${m.pushName}*\n𝚌𝚘𝚗𝚝𝚊𝚌𝚝 𝚘𝚠𝚗𝚎𝚛📍\nwa.me/918590822912 (Click To Contact)` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
                reply(`ɢɪᴛʜᴜʙ : https://github.com/MUNAVIR/MR-BOTV1\n \n\n`)
            }
            break
case 'allmenu': {
  	anu = `
...
┃🔖${prefix}report [bug]
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "YouTube 📍","url": `${myweb}`}},{"urlButton": {"displayText": "ꜱᴄʀɪᴩᴛ💫","url": `${sc}`}},{"quickReplyButton": {"displayText": ''ᴅᴏɴᴀᴛᴇ'',"id": 'donate'}},{"quickReplyButton": {"displayText":ᴏᴡɴᴇʀ,"id": 'owner'}}] )
break
...
┃🔖${prefix}delvote
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "ɪɴꜱᴛᴀɢʀᴀᴍ🍻","url": `${myweb}`}},{"urlButton": {"displayText": "ꜱᴄʀɪᴩᴛ💫","url": `${sc}`}},{"quickReplyButton": {"displayText": ''ᴅᴏɴᴀᴛᴇ'',"id": 'donate'}},{"quickReplyButton": {"displayText":ᴏᴡɴᴇʀ,"id": 'owner'}}] )
break
...
𝚃𝚑𝚊𝚗𝚔𝚜 𝚝𝚘 𝚊𝚕𝚕 🤗
   ...
   !!!`,unicorn, [{"urlButton": {"displayText": "ɪɴꜱᴛᴀɢʀᴀᴍ🍻","url": `${myweb}`}},{"urlButton": {"displayText": "ꜱᴄʀɪᴩᴛ💫","url": `${sc}`}},{"quickReplyButton": {"displayText": ''ᴅᴏɴᴀᴛᴇ'',"id": 'donate'}},{"quickReplyButton": {"displayText":ᴏᴡɴᴇʀ,"id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
